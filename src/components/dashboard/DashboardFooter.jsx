            ...
            <div className="max-w-[1200px] mx-auto px-6 py-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <Link to="/" className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold"><span className="text-[#131613]">Agro</span><span className="text-primary">Sense</span></span>
                    </Link>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mt-4 pt-4 border-t border-gray-100">
                    <p className="text-[10px] text-gray-400">© 2026 <span className="font-semibold"><span className="text-gray-500">Agro</span><span className="text-primary">Sense</span></span>. All rights reserved.</p>
