            ...
            <div className="w-full max-w-[1200px] flex flex-col gap-6">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-semibold"><span className="text-[#131613]">Agro</span><span className="text-primary">Sense</span></span>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-[10px] text-gray-400 text-center md:text-left">
                    <p>© 2026 <span className="font-semibold"><span className="text-[#131613]">Agro</span><span className="text-primary">Sense</span></span>. All rights reserved.</p>
