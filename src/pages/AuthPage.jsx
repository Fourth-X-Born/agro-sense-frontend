                ...
                <div className="flex w-full max-w-[720px] bg-white rounded-lg shadow-lg overflow-visible">
                    ...
                    <div className="hidden md:flex w-[38%] relative rounded-l-lg overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col justify-between p-4 h-full">
                            ...
                            <div className="flex flex-col gap-2">
                                <h2 className="text-white text-lg font-bold leading-tight transition-all duration-500">
                                    {isLogin ? "Welcome Back, Farmer!" : "Empowering Sri Lankan Agriculture"}
                                </h2>
                                <p className="text-gray-200 text-[10px] leading-relaxed transition-all duration-500">
                                    {isLogin
                    ...
                    <div className="flex-1 p-5 rounded-r-lg bg-white">
                        ...
                        <div className="text-center mb-3">
                            <h1 className="text-base font-bold text-[#131613] transition-all duration-500">
                                {isLogin ? "Welcome back" : "Create your account"}
                            </h1>
                            <p className="text-gray-500 text-[10px] mt-0.5 transition-all duration-500">
                        ...
                        <div className="flex border-b border-gray-200 mb-3">
                            <button
                                ...
                                className={`flex-1 text-center py-1.5 text-[10px] font-medium border-b-2 transition-all duration-500 ${isLogin
