      ...
      <main className="flex-1 max-w-[1200px] mx-auto w-full px-6 py-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          ...
          <div className="flex gap-2 mt-3 md:mt-0">
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 rounded-full text-xs text-gray-700">
          ...
          <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center">
                <span className="material-symbols-outlined text-green-500">water_drop</span>
              </div>
              <div className="flex-1">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-100">
                ...
                <span className="px-2.5 py-1 bg-red-50 text-red-500 text-[10px] font-medium rounded-full border border-red-200">
                  Urgent Action
                </span>
              </div>
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-4">
                  ...
                  <div className="flex gap-3">
                    <Link to="/crop-risk" className="px-4 py-2 bg-primary text-white text-xs font-medium rounded-lg hover:bg-primary/90 transition-colors">
                      Read Full Analysis
                    </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
              ...
              <div className="space-y-3">
                <Link to="/crop-risk" className="w-full flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors group">
                  ...
                  <span className="material-symbols-outlined text-gray-400 text-sm group-hover:text-gray-600">chevron_right</span>
                </Link>

                <Link to="/market-prices" className="w-full flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors group">
                  <div className="w-9 h-9 rounded-lg bg-white border border-gray-200 flex items-center justify-center">
