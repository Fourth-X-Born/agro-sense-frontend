            ...
            <main className="flex-grow">
                <div className="max-w-[1200px] mx-auto w-full px-6 py-10 animate-fade-in-up">
                    ...
                    <div className="text-center mb-10 animate-fade-in-down">
                        <h1 className="text-3xl md:text-4xl font-bold text-[#131613]">Privacy Policy</h1>
                    ...
                    {/* Introduction */}
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 mb-8 animate-fade-in-down">
                    ...
                    <div className="bg-primary rounded-xl p-6 mt-8 text-white text-center animate-fade-in-up">
                        ...
                        <p className="text-xs text-white/80 mb-4 max-w-md mx-auto">
                            Join thousands of Sri Lankan farmers using AgroSense AI for smarter farming decisions
                        </p>
                        <Link 
                            to="/register"
