            ...
            <main className="flex-grow">
                <div className="max-w-[1200px] mx-auto w-full px-6 py-10 animate-fade-in-up">
                    ...
                    <div className="text-center mb-10 animate-fade-in-down">
                        <h1 className="text-3xl md:text-4xl font-bold text-[#131613]">Terms of Service</h1>
                    ...
                    {/* Introduction */}
                    <div className="bg-gradient-to-r from-primary to-green-600 rounded-xl p-5 mb-8 text-white animate-fade-in-down">
                    ...
                    {/* Quick Summary */}
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8 animate-fade-in-down">
                    ...
                    {/* CTA Section */}
                    <div className="bg-primary rounded-xl p-6 mt-8 text-white text-center animate-fade-in-up">
                        <h3 className="text-lg font-bold mb-2">Agree to Terms & Get Started</h3>
                        ...
                        <div className="flex justify-center gap-3">
                            <Link 
                                to="/register"
                                className="inline-block px-6 py-2.5 bg-white text-primary text-xs font-medium rounded-lg hover:bg-white/90 transition-all"
                            >
                                Create Free Account
                            </Link>
                            <Link 
                                to="/privacy-policy"
                                className="inline-block px-6 py-2.5 bg-white/10 text-white text-xs font-medium rounded-lg hover:bg-white/20 transition-all"
                            >
                                View Privacy Policy
                            </Link>
                        </div>
